...
async def pali(ccx: str, max_retries=5):
    for attempt in range(max_retries):
        try:
            ...
            headers = {
                'authority': 'jettydive.com.au',
                'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8',
                'accept-language': 'ar-EG,ar;q=0.9,en-US;q=0.8,en;q=0.7',
                'cache-control': 'max-age=0',
                'referer': 'https://jettydive.com.au/product/donate-to-our-recycling-fund/',
            ...
            async with aiohttp.ClientSession(timeout=timeout) as session:
                ...
                async with session.get(
                    'https://jettydive.com.au/product/donate-to-our-recycling-fund/',
                    cookies=cookies,
                    headers=headers,
                    params=params,
                    proxy=proxy
                ...
                headers2.update({
                    'accept': '*/*',
                    'origin': 'https://jettydive.com.au',
                    'referer': 'https://jettydive.com.au/product/donate-to-our-recycling-fund/?form-id=14343&payment-mode=paypal-commerce&level-id=3',
                })
                ...
                form_data.add_field('give-current-url', 'https://jettydive.com.au/product/donate-to-our-recycling-fund/')
                form_data.add_field('give-form-url', 'https://jettydive.com.au/product/donate-to-our-recycling-fund/')
